...
<div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
    <div class="sm:flex sm:items-center">
        <div class="sm:flex-auto">
            ...
            <p class="mt-2 text-sm text-slate-700">Liste de tous les utilisateurs enregistrés et leurs rôles.</p>
        </div>
                    ...
                    <table class="min-w-full divide-y divide-slate-300">
                        <thead class="bg-slate-50">
                            <tr>
                                ...
                                <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-slate-900">Rôle</th>
                        ...
                        <tbody class="divide-y divide-slate-200 bg-white">
                            ...
                            <tr class="hover:bg-slate-50 transition-colors">
                                ...
                                <td class="whitespace-nowrap px-3 py-4 text-sm text-slate-700">
                                    <span class="inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-medium {{ $user->role === 'admin' ? 'bg-purple-100 text-purple-800' : 'bg-green-100 text-green-800' }}">
                                        {{ ucfirst($user->role) }}
                                    </span>
                                </td>
